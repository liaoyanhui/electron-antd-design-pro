 ...
 * @LastEditTime: 2021-11-05 14:08:26
 * @FilePath: /mining-admin-desktop/src/pages/OwnerPay/PayComponents/OwnerStayCheck.tsx
 */
...
const OwnerStayCheck: React.FC = () => {
  ...
  // 通过
  const handleOk = () => {
    OwnerService.processFilecoinWithdraw(
  ...
  // 不通过
  const handleCancel = () => {
    OwnerService.refuseFilecoinWithdraw(
      { withdrawNo: activeOrder.withdrawNo },
      {
        data: {
