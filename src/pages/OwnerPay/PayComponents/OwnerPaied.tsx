 ...
 * @LastEditTime: 2021-11-05 14:11:57
 * @FilePath: /mining-admin-desktop/src/pages/OwnerPay/PayComponents/OwnerPaied.tsx
 */
    ...
    <>
      <ProTable<Banner.FormProps, Global.PageParams>
        ...
        request={async (params = {}, sort, filter) => {
          ...
          return OwnerService.getFilecoinWithdrawCompleteList({
            // state: 'completed',
            // filter: 'completed',
          }).then((res: any) => {
            return {
