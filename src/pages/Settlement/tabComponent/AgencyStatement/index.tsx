 ...
 * @LastEditTime: 2022-01-13 10:19:19
 * @FilePath: /mining-admin-desktop/src/pages/Settlement/tabComponent/AgencyStatement/index.tsx
 */
...
const AgencyStatement: React.FC = () => {
          ...
          <>
            <a
              ...
              onClick={() => {
                setStatement(text);
                history.push(
                  `/settlement/settled/agencyStatementCheck?settlementNo=${text.settlementNo}`,
                );
              }}
            >
              查看
    ...
    <>
      <ProTable<Banner.FormProps, Global.PageParams>
        ...
        request={async (params = {}, sort, filter) => {
          return FilecoinService.getFilecoinReferrerSettlementList({
            filterBy: 'state',
            filter: 'confirmed',
          }).then((res: any) => {
            formatArr(res || []);
        ...
        toolBarRender={() => [
          <CSVLink data={csvData} filename="商务收益列表.csv" target="_blank">
