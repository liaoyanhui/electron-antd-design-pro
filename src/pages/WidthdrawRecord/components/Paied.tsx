 ...
 * @Description:
 * @Author: 尚夏
 * @Date: 2021-11-05 14:22:32
 * @LastEditTime: 2021-11-09 15:30:26
 * @FilePath: /mining-admin-desktop/src/pages/WidthdrawRecord/components/Paied.tsx
 */
    ...
    <>
      <ProTable<Banner.FormProps, Global.PageParams>
        ...
        request={async (params = {}, sort, filter) => {
          ...
          return WithdrawRecord.getFilecoinWithdrawCompleteList({
            // state: 'refused',
            // filter: 'pending',
          }).then((res: any) => {
            return {
